...
for i in os.listdir("./reference_models_processed"):

    npz_path = f"./reference_models_processed/{i}/voxel_and_sdf.npz"
    ...
    mesh_tri.export(f"./reference_models_processed/{i}/voxel_64_mc.off")
# # Voxel Mesh
